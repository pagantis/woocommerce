            ...
            foreach ($dbCurrentConfig as $item) {
                if ($item['config'] == 'PAGANTIS_SIMULATOR_CSS_PRICE_SELECTOR') {
                    ...
                    if ($item['value'] != $css_price_selector) {
                        $wpdb->update($tableName, array('value' => stripslashes($css_price_selector)), array('config' => 'PAGANTIS_SIMULATOR_CSS_PRICE_SELECTOR'), array('%s'), array('%s'));
                    }
                    ...
                    if ($item['value'] != $css_quantity_selector) {
                        $wpdb->update($tableName, array('value' => stripslashes($css_quantity_selector)), array('config' => 'PAGANTIS_SIMULATOR_CSS_QUANTITY_SELECTOR'), array('%s'), array('%s'));
                    }
                }
            }
        }
