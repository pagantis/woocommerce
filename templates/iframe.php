<link rel="stylesheet" type="text/css" media="all" href="<? echo $css ?>"}">
<div class="paylater-content">
    <div id="myModal" class="paylater_modal" style="display: block;">
        <div class="paylater_modal-content">
            <iframe id="iframe-pagantis" name="iframe-pagantis" style="width: 100%; height: 100%; display: block" frameborder="0" src="<? echo $url;?>">
            </iframe>
    ...
    <script type="text/javascript">
        var closeModal = function closeModal(evt) {
            evt.preventDefault();
            window.location.href = "<? echo $checkoutUrl ?>";
        };
